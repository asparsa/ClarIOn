#ifndef DFTRACER_UTILS_UTILITIES_FILEIO_TYPES_COMPRESSED_DATA_H
#define DFTRACER_UTILS_UTILITIES_FILEIO_TYPES_COMPRESSED_DATA_H
...
namespace std {
template <>
struct hash<dftracer::utils::utilities::fileio::CompressedData> {
    std::size_t operator()(
        const dftracer::utils::utilities::fileio::CompressedData& compressed)
        const noexcept {
...
#endif  // DFTRACER_UTILS_UTILITIES_FILEIO_TYPES_COMPRESSED_DATA_H
